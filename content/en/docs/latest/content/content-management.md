...
| photoCredits        | {{</* release version="v0.18" state="deprecated" */>}} Use `thumbnail.author` instead. |
| photoSource         | {{</* release version="v0.18" state="deprecated" */>}} Use `thumbnail.origin` instead. |
